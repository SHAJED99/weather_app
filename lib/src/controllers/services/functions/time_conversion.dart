...
import 'package:weather_app/src/controllers/services/functions/string_conversion.dart';

extension DateTimeExtensions on DateTime {
  String get customGreetingText {
    if (hour < 12) {
      return 'Good morning';
    } else if (hour < 18) {
  ...
  String get custom_d_MMM_yyy => DateFormat('d MMM yyyy').format(toLocal());
  String get custom_hh_mm_a_d_MMM_yyy_z => "${DateFormat('hh:mm a, d MMM yyyy').format(toLocal())}(${toLocal().timeZoneName})";
